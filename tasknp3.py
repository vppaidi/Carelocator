...
def recommend_task3(selected_dropdown, uploaded_data_json, facilit, P_FACILITIES, origins, wei, addresses):
...
#       destinations = pd.DataFrame(json.loads(destinations))
    ...
    up = pd.read_json(uploaded_data_json)
    ...
    print("This is the number o rows in origins", num_rows)
