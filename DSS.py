...
#This is used to exploit using given facilities when Sweden
...
def pfac():
    ...
    if selected_dropdown in predata:
        ...
        job = queue.enqueue(pfac_task2, selected_dropdown, P_FACILITIES, uploaded_data_json, facilit,  dm, origins, wei, addresses, job_timeout=17200)
...
def download_example2():
    ...
    # Send the example file for download
    return send_from_directory('static', 'examples/address.csv', as_attachment=True)    
