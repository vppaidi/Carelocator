...
# Always load datacsv.csv from GitHub
...
def _load_preloaded_od(name: str):
    """Load a precomputed OD matrix <name>.csv from GitHub (no local fallback)."""
    try:
        url = f"{GITHUB_RAW_BASE}/{urllib.parse.quote(name, safe='')}.csv"
